...
#==============================================================
# Script: startapps.sh
# Purpose: Start Applications Tier for EBS FSDR with secret handling
...
# Start Apps Tier
echo "INFO: Starting Applications tier..."
{ echo apps; echo "$SECRET_APPS"; echo "$SECRET_WEBLOGIC"; } | "$ADMIN_SCRIPTS_HOME/adstrtal.sh" -nopromptmsg || {
    echo "ERROR: Startup failed."
    exit 1
}

echo "INFO: Applications tier started successfully."
